...
public class Ddb2JsonInputTypeTest {
    ...
    void shouldMapUpdateItemHeaders() throws Exception {
        ...
        exchange.getMessage().setBody(mapper.readTree("{\"operation\": \"" + Ddb2Operations.UpdateItem.name() + "\", \"key\": " + keyJson + ", \"item\": " + itemJson + "}"));
    ...
    void shouldFailForWrongBodyType() throws Exception {
        ...
        Assertions.assertThrows(CamelExecutionException.class, () -> inputType.convertIn(exchange));
    }
    ...
    void shouldFailForUnsupportedOperation() throws Exception {
        ...
        Assertions.assertThrows(UnsupportedOperationException.class, () -> inputType.convertIn(exchange));
    }
